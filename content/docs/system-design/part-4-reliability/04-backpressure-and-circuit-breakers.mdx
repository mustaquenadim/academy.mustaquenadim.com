...
stateDiagram-v2
  ...
  Open: OPEN — reject instantly, return fallback
  HalfOpen: HALF-OPEN — allow a few test calls

  Closed --> Closed: failures under threshold
  Closed --> Open: fail rate over 50%
  Open --> HalfOpen: after cooldown (10s)
  HalfOpen --> Closed: probes ok
